            ...
            <div class="col-md-6 right-box">
                <div class="row align-item-center">
                    <form action = "signup_db.php" method="post">                       
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" name="c_password" type="password" placeholder="Confirm Password" aria-label="default input example">
                        </div>

                        <div>
                            <button type="submit" name = "signup" class="w-100 fs-6 btn btn-primary">Sign Up</button>
                        </div>

                       <br>
                        <div class="mb-6">
                            <small>มีบัญชีแล้วใช่ไหม? <a href="signin.php">เข้าสู่ระบบ</a></small>
                        </div>
